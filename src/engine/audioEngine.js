...
export const initAudioEngine = () => {
    ...
    const sounds = {
        'music-game': { url: 'https://freesound.org/data/previews/452/452603_9962461-lq.mp3', loop: true, volume: 0.5 },
        ...
        'hurry': { url: 'https://freesound.org/data/previews/254/254316_4062622-lq.mp3', loop: false, volume: 0.8 },
